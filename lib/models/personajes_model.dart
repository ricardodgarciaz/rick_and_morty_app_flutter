...
// Modelo Para Mapea los Personajes
import 'dart:convert';

PersonajesModel personajesModelFromJson(String str) => PersonajesModel.fromJson(json.decode(str));

String personajesModelToJson(PersonajesModel data) => json.encode(data.toJson());
